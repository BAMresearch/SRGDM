...
class TDKernelDMVW(object):
    ...
    def calculate_maps(self):
        ...
        # r
        temporary_min_val = np.min(self.importance_weight_map[np.nonzero(self.importance_weight_map)])
        self.importance_weight_map[self.importance_weight_map<temporary_min_val] = temporary_min_val/10
        ...
        for i in range(0, self.get_measurements_length()):
            ...
            distance_matrix = get_distance_matrix(cell_grid_x, cell_grid_y, x, y)
