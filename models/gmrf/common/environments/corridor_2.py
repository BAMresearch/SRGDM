...
relative_csv_file = "../data/test_environments/corridor/2/data.csv"
...
corridor_2 = environment.EnvironmentGroundTruth.fromGadenCsv(csv_file)
...
print("Loading corridor_2 obstacle map at 0.25m ... ", end =" ")
...
corridor_2_ccm_100 = CellConnectivityMap.fromMatrix(low_res_conn, size=(15,5), resolution=1)
